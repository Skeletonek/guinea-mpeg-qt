...
Column {
    ...
    property var pixfmtOptions: ["yuv420p", "yuv422p", "yuv444p", "yuv420p10le", "yuv422p10le", "yuv444p10le", "nv12"]
    ...
    Column {
        ...
        Row {
            ...
            TextField {
                ...
                placeholderText: "slow, medium, 0-13 for SVT-AV1"
                onTextChanged: if (!root.loading) root.changed()
            }
        }
    ...
    function getData() {
        ...
        var data = {
            ...
            pixel_format: pixfmtCombo.currentText || null,
